...
class Constants {
  ...
  static const dropDownUpIcon = Icons.arrow_drop_up_rounded;
  static const dropDownIcon = Icons.arrow_drop_down_rounded;
  ...
  static final List<String> questionType = [
    'Multiple Choice',
    'Fill in the blanks',
  ];

  static final List<String> difficultyLevel = ['Easy', 'Medium', 'Hard'];

  //app images
  static const String googleImage = "lib/assets/images/google-icon.png";
  static const String glaukImage =
